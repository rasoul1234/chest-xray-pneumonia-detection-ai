...
def show_terms_conditions():
    ...
    st.markdown("""
    ### Service Description
    PneumoScan AI provides AI-powered chest X-ray analysis for preliminary pneumonia screening.
    ...
    ### Contact & Support
    - **Email:** rasoul.sahibbzadah@auaf.edu.af
    - **Developer:** Muhammad Rasoul Sahibzadah, Senior AI Developer
    """)
...
def show_refund_policy():
    ...
    **PneumoScan AI is currently offered as a free service for research and educational purposes.**
...
def show_contact_us():
    ...
    with col1:
        ...
        st.markdown(
            '<span style="font-size:1.2em;font-weight:bold;">Developed by: Muhammad Rasoul Sahibzadah, Senior AI Engineer</span><br>'
            '<span style="font-size:1em;">Full-Stack Developer</span>',
            unsafe_allow_html=True
        )
        st.markdown(
            """
            ### 📬 Contact Details
            - **Email:** <a href='mailto:rasoul.sahibbzadah@auaf.edu.af'>rasoul.sahibbzadah@auaf.edu.af</a>
            - **Response Time:** 24-48 hours
    ...
    with col2:
        st.markdown("""
        ### 🔗 Professional Links
        - **LinkedIn:** [linkedin.com/in/rasoul-sahibzadah](https://linkedin.com/in/rasoul-sahibzadah)
        - **GitHub:** [github.com/rasoulsahibzadah](https://github.com/rasoulsahibzadah)
        - **Email:** rasoul.sahibbzadah@auaf.edu.af
    ...
    st.info("🚀 **We're here to help!** Feel free to reach out with any questions about PneumoScan AI.")
...
def generate_medical_pdf_report(prediction_result, analysis_time, original_image=None, ai_focus_image=None):
    ...
    pdf.cell(0, 12, 'PneumoScan AI - Medical Analysis Report', 0, 1, 'C')
    pdf.ln(5)
...
.fixed-header:hover {
 ...
 .stButton > button {
    /* Ensure footer legal buttons have the same height */
...
st.markdown(
    ...
    <div class="fixed-header">
        <a href="#" class="header-brand">
            <span class="header-text">PneumoScan AI</span>
        </a>
    </div>
    """,
    unsafe_allow_html=True,
...
# File uploader
uploaded_file = st.file_uploader("Upload an image file", type=["jpg", "jpeg", "png", "dcm"], key="upload")
                    ...
                    try:
                        with st.spinner("Generating Enhanced PDF..."):
                            ...
                            if original_img is None:
                                ...
                                filename = f"PneumoScan_Enhanced_Report_{int(time.time())}.pdf"
...
st.markdown(
    """
                ...
                <div class="developer-bio">
                    <span style="font-size:1.2em;font-weight:bold;">Muhammad Rasoul Sahibzadah, Senior AI Engineer</span>
                </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    ...
    <div class="social-section">
        ...
        <div class="social-icons">
            <a href="https://github.com/rasoul1234" target="_blank" title="GitHub">
            ...
            <a href="mailto:rasoul.sahibbzadah@auaf.edu.af" title="Gmail">
            ...
            <a href="https://www.linkedin.com/in/muhammad-rasoul-sahibzadah-b97a47218/" target="_blank" title="LinkedIn">
            ...
            <a href="https://huggingface.co/RasoulSahibzadah" target="_blank" title="Hugging Face">
...
st.markdown(
    ...
    <div class="footer">
        <div class="footer-links">
            <a href="https://github.com/rasoul1234/chest-xray-pneumonia-detection-ai" target="_blank">Source Code & Model Details</a>
            <a href="mailto:rasoul.sahibbzadah@auaf.edu.af">Contact</a>
        </div>
        <div>© 2026 {MODEL_SPECS['name']} {MODEL_SPECS['version']} | All Rights Reserved</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
with legal_col3:
    if st.button("Refund Policy", key="footer_refund", use_container_width=True):
        st.session_state.show_legal_page = "refund"
        st.rerun()

with legal_col4:
    if st.button("Contact Us Now", key="footer_contact", use_container_width=True):
